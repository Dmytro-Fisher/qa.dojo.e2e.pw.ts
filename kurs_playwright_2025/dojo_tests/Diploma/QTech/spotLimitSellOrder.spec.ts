...
test("QT-0009. Create spot limit sell order and cancel", async ({ page }) => {
  ...
  await page.locator('[data-testid-input="price-sell"]').click();
  await page
    .locator('[data-testid-input="price-sell"]')
    .pressSequentially("100000.000000");
  ...
  await page
    .locator('[data-testid-button="cancel-order-sell"]')
    .first()
    .click();
